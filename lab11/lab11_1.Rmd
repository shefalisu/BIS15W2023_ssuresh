...
homerange %>% 
  ...
  geom_histogram(alpha = 1, color = "black", fill = "lavenderblush", bins=40)+
...
homerange %>% 
  ...
  geom_histogram(alpha = 1, color = "black", fill = "lavender", bins=10)+
...
homerange %>% 
  ggplot(aes(x=log10.hra)) +
  geom_histogram(aes(y = ..density..), fill = "lavender", alpha = 1, color = "black")+
...
homerange %>% 
  ggplot(aes(x=log10.hra)) +
  geom_histogram(aes(y = after_stat(density)), fill = "lavender", alpha = 1, color = "black")+
  geom_density(color = "blue")+
  labs(title = "Distribution of Homerange")
```
...
```{r}
homerange <- homerange %>% 
  mutate(range_catergory = case_when(log10.hra<3.65 ~ "very_small",
...
```{r}
homerange %>% 
  ggplot(aes(x=range_catergory, fill = class))+
  geom_bar(position = "dodge", alpha =0.6, color ="black")+
  labs(title = "Observations by Range Catergory",
       x = "Range Catergory",
       y = "Class")
```
