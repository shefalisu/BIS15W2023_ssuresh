...
#How to install tidyverse - only do it once 
...
```{r}
hot_springs <- readr::read_csv("hsprings.data.csv")
```
...
#changing the class of scientists to a factor instead of a character 
