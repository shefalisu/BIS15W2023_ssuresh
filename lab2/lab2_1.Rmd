...
```{r}
mean_speed <- sum(venom_GT, chiron, veyron)/3
(270+261+268)/3
```
...
I think that NAs may overide the values in the data set. I think this might happen because they represent missing data values 
