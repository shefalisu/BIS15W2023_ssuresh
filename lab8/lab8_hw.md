...
```
## here() starts at /Users/shefali/Desktop/BIS15W2023_ssuresh-main/lab8
```
...
```
## [1] "/Users/shefali/Desktop/BIS15W2023_ssuresh-main/lab8"
```
...
No, the data is not "tidy" because the observations are spread out over multiple rows. The data is in a long format. 
