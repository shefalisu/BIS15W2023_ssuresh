...
#R is not picking up the NAs in the data fram. EX: mean if the body mass is negative 
```{r}
summary(amniota)
```
...
#The histogram is odd because there are negative values 
...
amniota_tidy <- amniota %>% 
  na_if("-999") #if it is -999, replace it with an NA
```
